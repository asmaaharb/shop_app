...
import 'package:tech_shop_app/screens/favorite/controller/get_likes_controller.dart';
...
class CatProductCard extends StatefulWidget {
  ...
  @override
  _CatProductCardState createState() => _CatProductCardState();
}
...
class _CatProductCardState extends State<CatProductCard> {
  ...
  Widget build(BuildContext context) {
    final controller =GetFavoriteController.of(context);
    //final product = controller.proList;
    return BlocBuilder(
      bloc: controller,
      builder: (context, state) => state is FavoriteLoading
